...
export default function ProfileCard({ data,owner,Name }: {Name:string, data: UserSchemaType,owner:boolean }) {
    ...
    return (<div className="w-[45em] md:w-[37em] mb-4 sm:px-4">
        ...
        <div className="w-full --crd rounded-xl p-4 mb-3">
            ...
            <div className="w-full h-[8em] sm:h-[10em] rounded-xl  bg-gradient-to-r from-blue-500  bg-blue-600 z-10 relative flex justify-center items-center">

                
                <h3 className="text-4xl text-blue-800 text-opacity-40 ">
                  {data.Tag}
                </h3>
               ...
               <div className="absolute right-2 bottom-2 flex justify-center items-center">
                   <Link href="/profile/update" > <i className="text-lg fill-blue-700 transition-colors cursor-pointer hover:fill-blue-800">
            ...
            <div className="w-full flex gap-2 px-6 md:px-4 sm:flex-wrap sm:items-center sm:justify-center  py-2 pb-4">
                ...
                <div className="w-[8em] h-[8em] sm:w-[12em] sm:h-[12em] bg-blue-600 flex justify-center items-center z-20 shadow-md rounded-full mt-[-4em] sm:mt-[-8em]">
        ...
        <div className="w-full flex justify-between gap-5 sm:block">
            ...
            <div className="w-3/5 sm:w-full flex flex-wrap gap-5 sm:gap-3">
                ...
                {
                    data.Posts.length != 0 ? data.Posts.reverse().map(e => <Post key={e.Text} Author={e.Author} date={e.Date} Text={e.Text} FullSize />) : data.Posts ? 
                    (
                        <>
                            No Posts here
                        </>
